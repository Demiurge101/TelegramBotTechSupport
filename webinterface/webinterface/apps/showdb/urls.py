...
path('documents/<int:pos>', views.documents, name='documents'),
...
path('edit_document/<backlink>/<number>/<uuid>', views.document_edit_form, name='edit_document'),
path('delete_document/<uuid>', views.delete_file, name='delete_document'),
path('delete_document/<backlink>/<number>/<uuid>', views.delete_file, name='delete_document'),
...
path('devices/<int:pos>', views.devices, name = 'devices'),
